...
from app.services.tjrn_scraper import TJRNScraper 
...
def main():
    ...
    try:
        scraper = TJRNScraper(headless=False)  # headless=False para visualização em DEBUG
        data = scraper.fetch_data()  # Executa coleta de todas as unidades
